...
export function ShopClient({
  ...
  return (
    <>
      ...
      {/* Header */}
      <header className='bg-white border-b sticky top-[6.4rem] z-40'>
              ...
              <div className='flex items-center space-x-4'>
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value='featured-desc'>
                      Featured First
                    </SelectItem>
                  </SelectContent>
                </Select>
...
export function useFilters(categories: TCategoryBasic[]) {
  ...
  // Filter handlers
  const handleFilterChange = (key: keyof TBookQueryFilter, value: any) => {
    switch (key) {
      case 'search':
        setSearch(value);
        break;
