export default function verificationOtpHtml({
  otp,
  title,
  subtitle,
  description,
  ...
  <div class="wrapper">
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="code" aria-label="Your one-time passcode">${otp}</div>
        <div>
          <a class="cta" href="${process.env.CLIENT_HOST}" target="_blank" rel="noopener">Open ahmadin</a>
        </div>
