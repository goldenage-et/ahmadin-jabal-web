export default function welcomeHtml({
  title,
  subtitle,
  description,
  ctaLink,
  ...
  <div class="wrapper">
    <div class="container">
      ...
      <div class="content">
        ...
        <div>
          <a class="cta" href="${ctaLink}" target="_blank" rel="noopener">${ctaLabel}</a>
        </div>
        <p class="muted">We’re excited to have you on ahmadin. Let us know if you need help.</p>
      </div>
      <div class="footer">
